...
FALCON PROTOCOL TOKEN
5% of every transaction is converted to BNB and sent to the marketing wallet
1% of every transaction is converted to BNB and go to liquidity pool
2% of every transaction is redistributed between holders of the token
1% of every transaction is burned
    
Telegram: https://t.me/falconprotocolofficialus
Twitter: https://twitter.com/ProtocolFalcon
Website: https://falconprotocol.finance
Github: https://github.com/FalconProtocol2021
...
contract FalconProtocolofficial is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 15600000000 * 10**9;
    ...
    uint256 public _maxTxAmount                   = 15600000000 * 10**9;
